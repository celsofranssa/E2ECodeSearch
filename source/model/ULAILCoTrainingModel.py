...
class ULAILCoTrainingModel(LightningModule):
    """
    ...
    def __init__(self, hparams):
        ...
        super(ULAILCoTrainingModel, self).__init__()
    ...
    def training_step(self, batch, batch_idx, optimizer_idx):
        ...
        if optimizer_idx == 0:
            ...
            desc_loss=self.desc_loss(code_repr, desc_repr)
            return desc_loss
        if optimizer_idx == 1:
            # loss concerning x2_encoder
            code_loss = self.code_loss(desc_repr, code_repr)
            return code_loss
